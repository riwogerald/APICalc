...
const AdvancedCalculator = {
    ...
    calculate: function(expression: string): string {
        // Remove whitespace
    ...
    handleFactorial: function(expr: string): string {
    ...
    // Handle square root
    handleSqrt: function(expr: string): string {
...
// Export for use in React/TypeScript
export default AdvancedCalculator;

// CommonJS export for compatibility
if (typeof globalThis !== 'undefined' && 'module' in globalThis) {
    (globalThis as any).module.exports = AdvancedCalculator;
}

// Global assignment for browser use
if (typeof window !== 'undefined') {
    (window as any).AdvancedCalculator = AdvancedCalculator;
}
